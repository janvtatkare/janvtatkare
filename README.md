...
) | [GitHub](https://github.com/janvtatkare)
...
**AI / LLMs**
LangChain • LangGraph • LlamaIndex • OpenAI • Gemini • HuggingFace • Vector Stores • RAG • Agentic Pipelines • Guardrails

**Backend**
Node.js • Express • FastAPI • REST • GraphQL • Python

**Frontend**
React • Next.js • Angular • TypeScript • Redux

**Cloud & DevOps**
AWS (Lambda, S3, EC2, RDS, SQS, CloudWatch) • Docker • CI/CD • Jenkins
